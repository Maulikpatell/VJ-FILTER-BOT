...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '788277212').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001654807256').split()]  # For Multiple Id Use One Space Between Each.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/hindi_movie_group_1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/dtg_tv')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'DTG_SUPPORT') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/DTG_TV')
